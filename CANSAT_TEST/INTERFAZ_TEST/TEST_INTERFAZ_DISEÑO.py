...
class GraphWindow(tk.Toplevel):
    ...
    Muestra un gráfico de líneas con estilo simple, actualizado
...
class CameraManager:
    ...
    def __init__(self, label_widget):
        ...
        Parámetros:
            label_widget (tk.Label): Widget donde mostrar los frames
        """
...
class DashboardApp:
    """
    Aplicación principal del dashboard CANSAT con diseño optimizado.
    
    Interfaz gráfica con 4 cuadrantes:
    - Superior izquierda: Métricas en vivo (BMP390L)
    ...
    def setup_dark_theme(self):
        ...
        style = ttk.Style()
        style.theme_use("clam")  # Necesario para poder modificar colores

        # Fondo general y widgets
    ...
    def create_layout(self):
        ...
        # Cuadrante II (superior izquierda): Datos BMP390L
        self.quad_II = ttk.LabelFrame(self.root, text="DATOS-BMP")
    ...
    def process_serial(self):
        ...
        while not self.data_queue.empty():
            ...
            try:
                ...
                # Actualizar sensores basados en claves JSON
                if "temp" in data:
                    value = data["temp"]
    ...
    def execute_action(self):
        ...
        - "Clear Data": Limpia todos los buffers de sensores y datos crudos
